...
# with command line options: rds/gen/python/dstau_cff_template.py --fileout file:HOOK_FILE_OUT --mc --eventcontent RAWSIM --datatier GEN --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN --geometry DB:Extended --era Run2_2018 --python_filename hammer/dstau_cfg_template.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('rds/gen/python/dstau_cff_template.py nevts:-1'),
