...
home = "/work/pahwagne/CMSSW_10_6_37/src/rds/gen/"
...
for imom in mothers:
    for idir in dirs:
        ...
        if idir.endswith(date_and_time) and idir.startswith(imom):
            ...
            "Size per event                              {0} KB  \n".format(int(size/passedevents + 1)), 
...
with open("/work/pahwagne/CMSSW_10_6_37/src/rds/gen/total_logs/log_{0}.txt".format(date_and_time), "wt") as flauncher:
