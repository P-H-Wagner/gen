...
generator = cms.EDFilter("Pythia8GeneratorFilter",
  ...
  ExternalDecays = cms.PSet(
    ...
    EvtGen130 = cms.untracked.PSet(
      ...
      #remark PDG ID of LambdaB is (5122), the default list is cms.vint32()
...
motherFilter = cms.EDFilter("MCSingleParticleFilter",
    ...
    ParticleID = cms.untracked.vint32(5122, -5122) # we need to explicitly list also cc mode, I checked.
)
...
DsToPhiPiFilter = cms.EDFilter(
     ...
     MotherIDs       = cms.untracked.vint32 (5122),  # Lambda B #charge irrelevant
